...
R0 = Ksz/Kzr;      %basic reproductive number
...
[t, p_a] = ode15s(@zombies_changing_rates,tspan,y0, options,k);
...
%Plot R0 over time
figure
plot(t_q, p_qa(:,6)./p_qa(:,7));
xlabel('Time (hours)')
ylabel('R0 basic reproductive number')
title('R0')
%% Functions
